...
{
    public class PlainAndFusionModel : PageModel
    {
        ...
        public PlainAndFusionModel(IWebHostEnvironment environment)
        {
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                Paths.AddNewImagePath(_environment);
                Model_Run_Preparations.RunModelAndSaveNewResult(SelectedModel1, Paths.Paths_of_images.First(), Paths.Paths_of_images.Last(), false); // plain
                Paths.AddNewImagePath(_environment);
                Model_Run_Preparations.RunModelAndSaveNewResult(SelectedModel2, Paths.Paths_of_images.First(), Paths.Paths_of_images.Last(), true); // fusion

...
namespace Kolorowanie.Services
{
    public class Model_Run_Preparations
    {
        ...
        //prepare input to Inception-ResNet-v2 model
        private static float[] GreyInception(Bitmap bitmap)
        {
            //resize input photo to 299x299 px
        ...
        private static float[] LoadImageWithPreparations(string path)
        {
            ...
            using (Bitmap original_bitmap = new Bitmap(path))
            {
                ...
                Squares_number_sum = Squares_number_width * Squares_number_height;

                colorMe1 = new float[Squares_number_sum * Square_width * Square_width];
        ...
        //convert imate to lab space and add padding
        private static float[] ConvertImageToLabAndAddPadding(Bitmap original_bitmap)
        {
            float[] color_me = new float[Squares_number_sum * Square_width * Square_width];
        ...
        //run model and get color photo with eventual padding
        ...
        //run model for one piece of photo - input of model
